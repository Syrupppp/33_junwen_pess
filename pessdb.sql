...
--
-- Host: 127.0.0.1
-- Generation Time: May 20, 2021 at 03:03 AM
...
(6, 'QX4444P', '2021-03-11 10:29:15', '2021-03-11 10:29:15', NULL),
(8, 'QX1234', '2021-03-11 10:31:29', NULL, '2021-03-18 11:35:00');
...
(0, 'PETERLEOW', '81234567', '010', 'Junction of North Bridge Road and Riddle Road', 'Bus collision 2 injuries', '1', '0000-00-00 00:00:00'),
(6, 'PETER LEOW', '81234567', '010', 'Junction of North Bridge Rd and Middle Road', 'A bus collided with a Taxi 2 injuries', '3', '2021-03-11 10:26:05'),
(8, 'qwerty', '12345678', '030', 'cck', 'qwerty', '3', '2021-03-10 10:27:10');
...
ALTER TABLE `dispatch`
  ADD PRIMARY KEY (`incident_id`,`patrol_car_id`),
...
ALTER TABLE `dispatch`
  ...
  ADD CONSTRAINT `dispatch_ibfk_2` FOREIGN KEY (`patrol_car_id`) REFERENCES `patrolcar` (`patrolcar_id`) ON DELETE CASCADE ON UPDATE CASCADE;
